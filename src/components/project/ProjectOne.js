                    ...
                    <div className="container-fluid">
                        <div className="sec-title text-center">
                            <div className="sec-title__tagline">
                                <span className="left"></span><h6>Portfolio</h6> <span className="right"></span>
                            </div>
                            {/* <h2 className="sec-title__title">Portfolio Projects</h2> */}
                        </div>
                        ...
                        <div className="row filter-layout masonary-layout">
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6 filter-item factory bulding">
                                <div className="project-one__single">
                                    <div className="project-one__single-img">
                                        <div className="inner">
                                            <img src={publicUrl+"assets/images/project/kitchenRemodel.jpeg"} alt="" />
                                            <div className="project-one__link">
                                                <a className="img-popup" href={publicUrl+"assets/images/project/kitchenRemodel.jpeg"}>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6 filter-item interios offices factory">
                                <div className="project-one__single">
                                    <div className="project-one__single-img">
                                        <div className="inner">
                                            <img src={publicUrl+"assets/images/project/livingroomRemodel.jpeg"} alt="" />
                                            <div className="project-one__link">
                                                <a className="img-popup" href={publicUrl+"assets/images/project/livingroomRemodel.jpeg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6 filter-item interios factory bulding">
                                <div className="project-one__single">
                                    <div className="project-one__single-img">
                                        <div className="inner">
                                            <img src={publicUrl+"assets/images/project/bathroom1Remodel.jpeg"} alt="" />
                                            <div className="project-one__link">
                                                <a className="img-popup" href={publicUrl+"assets/images/project/bathroom1Remodel.jpeg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div className="col-xl-3 col-lg-3 col-md-6 filter-item bulding offices">
                                <div className="project-one__single">
                                    <div className="project-one__single-img">
                                        <div className="inner">
                                            <img src={publicUrl+"assets/images/project/bathroom2remodel.jpeg"} alt="" />
                                            <div className="project-one__link">
                                                <a className="img-popup" href={publicUrl+"assets/images/project/bathroom2remodel.jpeg"}>
                                                    <span className="icon-plus-sign"></span>
                                                </a>
                                            </div>
                                        </div>
